...
def server_logic(input, output, session):
    ...
    def funnel_at_glance():
        ...
        FUNNEL_W = 170      # width of funnel area
        RIGHT_MARGIN = 72   # space for pills on right
        ...
        for i, (label, key) in enumerate(stages):
            ...
            svg_parts.append(
                ...
                f'font-family="Manrope,sans-serif" font-size="7.5" font-weight="600" '
            ...
            if i == n - 1:
                ...
                if deposits > 0:
                    ...
                    svg_parts.append(
                        ...
                        f'font-family="Manrope,sans-serif" font-size="7" font-weight="600" '
                        f'fill="#9B9893">Melt</text>'
                    )
                    svg_parts.append(
                        f'<text x="{pill_x}" y="{pill_y + 6:.1f}" '
                        f'dominant-baseline="middle" text-anchor="start" '
                        f'font-family="Manrope,sans-serif" font-size="10" font-weight="700" '
